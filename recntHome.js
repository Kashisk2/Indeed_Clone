...
var allData = JSON.parse(localStorage.getItem("search")) || [];
function findData() {
  ...
  if (output1 == "" && output2 == "") {
    ...
    allData.push(output1);
    allData.push(output2);
    //   localStorage.setItem("search", JSON.stringify(allData));
    showData(allData);
  }
}

function showData(allData) {
  allData.map(function (elm, i) {
    var div = document.createElement("div");

    var div1 = document.createElement("div");
    div1.innerText = allData[i];

    div.append(div1);

    document.getElementById("mainData").append(div);
  });
}
